...
class OfficeAddDateslotRecapView extends StatefulWidget {
  final Office office;
  final int slots;
  final String nicerTime;
  final DateTime dateValue;
  OfficeAddDateslotRecapView({
  ...
  @override
  _OfficeAddDateslotRecapState createState() => _OfficeAddDateslotRecapState();
}

class _OfficeAddDateslotRecapState extends State<OfficeAddDateslotRecapView> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Column(
                          children: <Widget>[
                            Text(
                              'Aggiunta di orari e date utili per donare per l\'ufficio di ${widget.office.getPlace()}',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 20,
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    ...
                                    TextSpan(
                                      text:
                                          '. Il numero di prenotazioni che è possibile accettare in tale fascia oraria è fino a ',
                                    ),
                                    TextSpan(
                                      text: '${widget.slots}.',
                                      style: TextStyle(
                                    ...
                                    TextSpan(
                                      text:
                                          '\n\nSi desidera proseguire con l\'aggiunta o declinare?',
                                      style: TextStyle(
                                    ...
                                    child: FloatingActionButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        new ConfirmationFlushbar(
                                                ...
                                                "L\'inserimento è stato annullato",
                                                false)
                                            .show(context);
                                      },
                                    ),
